...
- **Miracle 031 hit the standing self-reference problem** and resolves it
  the standing way: `git tag -n1 v0.13.0-miracle-031` / `git rev-list -n1
  v0.13.0-miracle-031`. Minor bump — a new subsystem, like 022 and 030.
  Third row in a row with **no ADR**, and for the cleanest reason yet: the
